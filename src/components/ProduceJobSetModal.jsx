...
export default function ProduceJobSetModal({
  ...
  return (
    <div className="fixed inset-0 bg-black/80 backdrop-blur-sm flex items-center justify-center z-50 p-4">
      ...
      {recalcModal.isOpen && (
        <div className="fixed inset-0 bg-black/80 backdrop-blur-sm flex items-center justify-center z-[100] p-4">
          <div className="bg-gray-900 border border-gray-800 rounded-xl w-full max-w-md shadow-2xl overflow-hidden animate-fade-in">
            <div className="p-6">
              <h3 className="text-xl font-bold text-white mb-2">Recalculate Production Chain</h3>
              <p className="text-sm text-gray-300 leading-relaxed mb-6">How would you like to apply the math cascade to this part's routing steps?</p>
              ...
              <div className="space-y-3">
                <button 
                  ...
                  className="w-full bg-primary-600 hover:bg-primary-500 text-white font-bold py-3 px-4 rounded-lg text-sm transition-colors shadow-lg flex items-center justify-between"
                >
                  <span>Recalculate untouched fields only</span>
                ...
                <button 
                  ...
                  className="w-full bg-red-600/10 text-red-400 hover:bg-red-600 hover:text-white border border-red-500/30 font-bold py-3 px-4 rounded-lg text-sm transition-colors flex items-center justify-between"
                >
                  <span>Reset everything (Wipes manual edits)</span>
                  <span>⚠</span>
                </button>
              </div>
              ...
              <div className="mt-6 flex justify-end">
                <button 
                  ...
                  className="px-5 py-2.5 text-gray-400 hover:text-white transition-colors font-medium bg-gray-800 rounded-lg text-sm"
                >
                  Cancel
                </button>
              </div>
      ...
      <div className="bg-gray-900 border border-primary-500/30 rounded-xl w-full max-w-4xl max-h-[90vh] flex flex-col shadow-2xl relative z-10">
